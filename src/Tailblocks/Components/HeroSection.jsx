      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col 
          ...
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
            Crafted for the Perfect Bite  
            <br className="hidden lg:inline-block" />
            Flavors You’ll Fall in Love With
          </h1>
          <p className="mb-8 leading-relaxed">
            "Welcome to SAKI ICE CREAMES – where every scoop is a sweet hug for your taste buds. Freshly churned, irresistibly creamy, and made with love to brighten your day.".
          </p>
